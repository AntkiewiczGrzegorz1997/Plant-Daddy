    ...
    ***************************************************************************** */
    ...
    var GenerativeRemove = /** @class */ (function (_super) {
        ...
        GenerativeRemove.prototype.region = function () {
            ...
            if (this._regions.length > 0) {
                this._actionModel.regions = this._regions.map(function (region) {
        ...
        GenerativeRemove.prototype.preparePromptValue = function () {
            ...
            var detectMultiple = this._detectMultiple;
            var qualifierValue = new QualifierValue().setDelimiter(";");
            if (prompts.length === 1) {
    ...
    var GenerativeReplace = /** @class */ (function (_super) {
        ...
        GenerativeReplace.fromJson = function (actionModel) {
            var from = actionModel.from, to = actionModel.to, preserveGeometry = actionModel.preserveGeometry;
            var result = new this();
            result.from(from);
            result.to(to);
            if (preserveGeometry) {
    ...
    var GenerativeRecolor = /** @class */ (function (_super) {
        ...
        GenerativeRecolor.prototype.multiple = function (value) {
            if (value === void 0) { value = true; }
            this._detectMultiple = value;
            if (this._detectMultiple) {
                this._actionModel.detectMultiple = this._detectMultiple;
        ...
        GenerativeRecolor.prototype.prepareQualifiers = function () {
            ...
            if (this._toColor) {
                var formattedColor = this._toColor.match(/^#/) ? this._toColor.substr(1) : this._toColor;
