...
--
-- Name: plants; Type: TABLE; Schema: public; Owner: postgres1
--
...
ALTER TABLE public.plants OWNER TO postgres1;

--
-- Name: uploaded_images; Type: TABLE; Schema: public; Owner: postgres1
--
...
ALTER TABLE public.uploaded_images OWNER TO postgres1;

--
-- Name: user_plants; Type: TABLE; Schema: public; Owner: postgres1
--
...
ALTER TABLE public.user_plants OWNER TO postgres1;

--
-- Name: users; Type: TABLE; Schema: public; Owner: postgres1
--
...
ALTER TABLE public.users OWNER TO postgres1;

--
-- Data for Name: plants; Type: TABLE DATA; Schema: public; Owner: postgres1
--
...
--
-- Data for Name: uploaded_images; Type: TABLE DATA; Schema: public; Owner: postgres1
--
...
--
-- Data for Name: user_plants; Type: TABLE DATA; Schema: public; Owner: postgres1
--
...
--
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: postgres1
--

COPY public.users (user_id, email, password, firstname, lastname, username) FROM stdin;
1	user1@example.com	password1	John	Doe	user1
2	user2@example.com	password2	Jane	Smith	user2
3	user3@example.com	password3	Alice	Johnson	user3
...
5972615898	gantkiewicz976@gmail.com	$2b$10$r7vXKqLapI7zwCjVynD.Re1mOLRphi62MSFdQoyZLIf2jodD9M9VO	Grzegorz	Antkiewicz	user4
...
--
-- Name: plants plants_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres1
--
...
--
-- Name: user_plants user_plants_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres1
--
...
--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres1
--
